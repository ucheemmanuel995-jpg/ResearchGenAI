...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    if not filled:
        ...
        full_parts = [
            ...
            f"Generated by ResearchGenAI · Powered by Groq + LLaMA 3.3\n"
            f"{'='*70}\n"
        ]
        ...
        if st.session_state.topic:
            st.markdown(
                ...
                f'Generated by ResearchGenAI · Powered by Groq + LLaMA 3.3</div>'
...
<div style="background:linear-gradient(135deg,#0a1a2e,#0d1526);
  ...
  <div style="font-family:Sora,sans-serif;font-size:12px;color:#7a9abf;line-height:1.7;">
    Help improve ResearchGenAI — report bugs, suggest features, or share your experience.<br>
...
st.markdown(
    ...
    '🔬 ResearchGenAI · Powered by Groq + LLaMA 3.3 70B · Free to Use'
    '</div>', unsafe_allow_html=True)
